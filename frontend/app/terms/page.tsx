...
export const metadata: Metadata = {
  ...
  description:
    'The terms and conditions for using the JustAJobApp application and services.',
};
    ...
    <main className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
        <p className="text-gray-700 dark:text-gray-300">
          ...
          conditions of your use of the "JustAJobApp" application ("Application" or
          ...
          or "your") and this Application developer ("Operator", "we", "us" or
          "our").
        </p>
        
        <p className="text-gray-700 dark:text-gray-300">
          By accessing and using the Application and Services, you acknowledge that
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          you, and it governs your use of the Application and Services.
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          You must be at least 18 years of age to use the Application and
          Services. By using the Application and Services and by agreeing to this
          Agreement you warrant and represent that you are at least 18 years of
          age.
        </p>
        
        <p className="text-gray-700 dark:text-gray-300">
          If you create an account in the Application, you are responsible for
        ...
        <p className="text-gray-700 dark:text-gray-300">
          We may suspend, disable, or delete your account (or any part thereof)
          if we determine that you have violated any provision of this Agreement
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          "Content") that you submit in the Application in the course of using the
        ...
        <p className="text-gray-700 dark:text-gray-300">
          We may, but have no obligation to, monitor and review the Content in the
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          specifically permitted by you, your use of the Application and Services
          does not grant us the license to use, reproduce, adapt, modify, publish
          or distribute the Content created by you or stored in your user account
        ...
        <p className="text-gray-700 dark:text-gray-300">
          We are not responsible for the Content residing in the Application. In no
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          the Application and Services at any time at our discretion. When we do,
          we will revise the updated date at the bottom of this page. We may also
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          terms and conditions. By accessing and using the Application and
          ...
          access or use the Application and Services.
        </p>
