...
export const metadata: Metadata = {
	title: "Terms and Conditions | JustAJobApp",
	description: "The terms and conditions for using the JustAJobApp application and services."
};

export default function TermsPage() {
	return (
		<main className="container mx-auto px-4 py-8 max-w-4xl">
			<h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Terms and Conditions</h1>

			<div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
				<p className="text-gray-700 dark:text-gray-300">
					These terms and conditions ("Agreement") set forth the general terms and conditions of your use of
					the "JustAJobApp" application ("Application" or "Service") and any of its related products and
					services (collectively, "Services"). This Agreement is legally binding between you ("User", "you" or
					"your") and this Application developer ("Operator", "we", "us" or "our").
				</p>

				<p className="text-gray-700 dark:text-gray-300">
					By accessing and using the Application and Services, you acknowledge that you have read, understood,
					...
					entity to this Agreement, in which case the terms "User", "you" or "your" shall refer to such
					entity. If you do not have such authority, or if you do not agree with the terms of this Agreement,
					you must not accept this Agreement and may not access and use the Application and Services.
				</p>

				<p className="text-gray-700 dark:text-gray-300">
					You acknowledge that this Agreement is a contract between you and the Operator, even though it is
					electronic and is not physically signed by you, and it governs your use of the Application and
					Services.
				</p>
				...
				<p className="text-gray-700 dark:text-gray-300">
					You must be at least 18 years of age to use the Application and Services. By using the Application
					and Services and by agreeing to this Agreement you warrant and represent that you are at least 18
					years of age.
				</p>

				<p className="text-gray-700 dark:text-gray-300">
					If you create an account in the Application, you are responsible for maintaining the security of
				...
				<p className="text-gray-700 dark:text-gray-300">
					We may suspend, disable, or delete your account (or any part thereof) if we determine that you have
				...
				<h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">User Content</h2>

				<p className="text-gray-700 dark:text-gray-300">
					We do not own any data, information or material (collectively, "Content") that you submit in the
				...
				<p className="text-gray-700 dark:text-gray-300">
					We may, but have no obligation to, monitor and review the Content in the Application submitted or
					created using our Services by you. You grant us permission to access, copy, distribute, store,
					transmit, reformat, display and perform the Content of your user account solely as required for the
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					permitted by you, your use of the Application and Services does not grant us the license to use,
					reproduce, adapt, modify, publish or distribute the Content created by you or stored in your user
					account for commercial, marketing or any similar purpose.
				</p>

				<h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Backups</h2>

				<p className="text-gray-700 dark:text-gray-300">
					We are not responsible for the Content residing in the Application. In no event shall we be held
				...
				<p className="text-gray-700 dark:text-gray-300">
					Although the Application and Services may link to other resources (such as websites, Applications,
					...
					the legal statements and other conditions of use of any resource which you access through a link in
					the Application and Services. Your linking to any other off-site resources is at your own risk.
				</p>
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					be used in any way that will affect the functionality or operation of the Application and Services,
					third party products and services, or the Internet; (h) to spam, phish, pharm, pretext, spider,
					crawl, or scrape; (i) for any obscene or immoral purpose; or (j) to interfere with or circumvent the
					security features of the Application and Services, third party products and services, or the
					Internet. We reserve the right to terminate your use of the Application and Services for violating
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					This Agreement does not transfer to you any intellectual property owned by the Operator or third
					parties, and all rights, titles, and interests in and to such property will remain (as between the
					parties) solely with the Operator. All trademarks, service marks, graphics and logos used in
					connection with the Application and Services, are trademarks or registered trademarks of the
					Operator or its licensors. Other trademarks, service marks, graphics and logos used in connection
					with the Application and Services may be the trademarks of other third parties. Your use of the
					Application and Services grants you no right or license to reproduce or otherwise use any of the
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					agents, suppliers and licensors relating to the services will be limited to an amount greater of one
					dollar or any amounts actually paid in cash by you to the Operator for the prior one month period
					prior to the first event or occurrence giving rise to such liability. The limitations and exclusions
					also apply if this remedy does not fully compensate you for any losses or fails of its essential
					purpose.
				</p>

				<h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Indemnification</h2>
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					including reasonable attorney fees, incurred in connection with or arising from any third party
					allegations, claims, actions, disputes, or demands asserted against any of them as a result of or
					relating to your Content, your use of the Application and Services or any willful misconduct on your
					part.
				</p>

				<h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Severability</h2>
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					shall be governed by the substantive and procedural laws of Alameda County, California, United States without regard
					...
					courts located in Alameda County, California, United States, and you hereby submit to the personal jurisdiction of
				...
				<p className="text-gray-700 dark:text-gray-300">
					We reserve the right to modify this Agreement or its terms relating to the Application and Services
					at any time at our discretion. When we do, we will revise the updated date at the bottom of this
					page. We may also provide notice to you in other ways at our discretion, such as through the contact
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					accessing and using the Application and Services you agree to be bound by this Agreement. If you do
					not agree to abide by the terms of this Agreement, you are not authorized to access or use the
					Application and Services.
				</p>

				<h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Contacting Us</h2>
				...
				<p className="text-gray-700 dark:text-gray-300">
					...
					<a
						...
						href="mailto:legal@justajobapp.com"
					>
