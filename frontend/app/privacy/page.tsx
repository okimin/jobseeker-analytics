        ...
        <main className="container mx-auto px-4 py-8 text-gray-800 dark:text-gray-200">
            ...
            <section className="mb-8">
                <p>
					...
					. Our operations prioritize transparency and data minimization. 
                    We do not request personal information unless required for core service functionality, i.e. increasing job search productivity.
                </p>
            </section>
                ...
                <table className="min-w-full border border-gray-300 mb-4 text-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="border p-2">Account authentication, security monitoring, and session management.</td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-6">
                <div className="p-3 border rounded bg-gray-50 dark:bg-gray-900">
                    ...
                    <ul className="list-disc list-inside">
                        <li><strong>Cloud:</strong> AWS, Google Cloud Platform</li>
                ...
                <div className="p-3 border rounded bg-gray-50 dark:bg-gray-900">
                    ...
                    <ul className="list-disc list-inside">
                        <li><strong>Messaging:</strong> Systeme.io, ConvertKit, MailerLite</li>
                        <li><strong>AI Processing:</strong> Google Cloud AI, Google Gemini API</li>
                        <li><strong>Compliance:</strong> Termly.io</li>
                    </ul>
                </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-3 mt-3 ml-4 text-sm">
                <li>
                    <strong>Initial Discovery:</strong> Potential job-related messages are identified based on 
                    keywords defined in our <a href="https://github.com/JustAJobApp/jobseeker-analytics/blob/main/backend/email_query_filters/applied_email_filter.yaml" className="text-blue-600 underline">applied_email_filter.yaml</a>.
                </li>
                <li>
                    <strong>Intelligent Analysis:</strong> An analysis layer defined in our <a href="https://github.com/JustAJobApp/jobseeker-analytics/blob/main/backend/utils/llm_utils.py" className="text-blue-600 underline">llm_utils.py</a> 
            ...
            <p className="text-sm">
                JustAJobApp LLC is based in the United States and the Websites are hosted in the United States. 
                If you are accessing the Websites from the European Union, Asia, or any other region with laws 
                governing data collection and use that differ from U.S. law, please note that you are transferring 
                your personal data to the United States.
            </p>
            ...
            <p className="text-sm">
                JustAJobApp adheres to the <a className="text-blue-600 underline ml-1" href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User Data Policy</a>.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4 text-sm">
                <li><strong>Right to Know:</strong> Disclosure of what data points are collected.</li>
                <li><strong>Right to Delete:</strong> Request data purge, subject to IRS guidance.</li>
                <li><strong>Right to Correct:</strong> Rectify inaccurate personal information.</li>
                <li><strong>Right to Opt-Out:</strong> JustAJobApp does not sell or share data for behavioral advertising.</li>
                <li><strong>Right to Limit Use:</strong> We restrict mailbox data usage to core service functions.</li>
                <li><strong>Do-Not-Track:</strong> As required by CalOPPA, we do not currently respond to browser DNT signals.</li>
            </ul>
            ...
            <p className="mb-6 text-sm">
                ...
                authorized support request, or security investigation. All production data access must be 
                specifically authorized by JustAJobApp LLC.
            </p>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <p>United States</p>
                <p className="mt-2 font-semibold">Privacy Officer: <a className="text-blue-600 underline" href="mailto:privacy@justajobapp.com">privacy@justajobapp.com</a></p>
            </div>
        </main>
    );
};
